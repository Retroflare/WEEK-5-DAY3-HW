...
--Create a query that fetches all payment records where the payment amount exceeds $6.99. Additionally, 
--include the full name of the customer associated with each payment
...
--Construct a query to retrieve the names of customers who have made only one payment, and 
--the payment amount exceeds $6.99. Utilize subqueries to accomplish this task.)
